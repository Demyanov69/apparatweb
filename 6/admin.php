    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['action']) && $_POST['action'] == 'delete' && isset($_POST['id']) && is_numeric($_POST['id'])) {
            ...
            try {
                ...
                echo('<p style="color: red;">Ошибка при удалении записи: ' . htmlspecialchars($e->getMessage()) . '</p>');
            }
        }
        ...
        if (isset($_POST['action']) && $_POST['action'] == 'edit' && isset($_POST['id']) && is_numeric($_POST['id'])) {
            ...
            if (empty($validation_errors)) { 
                try {
                    ...
                    echo('<p style="color: red;">Ошибка при обновлении записи: ' . htmlspecialchars($e->getMessage()) . '</p>');
                }
            } else {
